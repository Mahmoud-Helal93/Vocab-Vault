...
export const RAW_WORDS: Omit<Word, "id" | "difficulty" | "lastReviewed" | "nextReview" | "status" | "interval" | "easeFactor" | "repetitions" | "correctCount" | "incorrectCount" | "qualityHistory" | "root" | "wordFamily">[] = [
  ...
  { word: "impecunious", pos: "adjective", arabic: "مفلس / بلا مال", definition: "Having little or no money; financially distressed.", examples: ["Impecunious students often rely on campus food banks and part-time jobs to make ends meet.", "The impecunious author struggled for years before his first novel became a bestseller.", "Despite being impecunious, she refused to borrow money and managed her expenses carefully."], synonyms: ["penniless", "poor", "impoverished"], day: 38, group: 1 },
  { word: "paucity", pos: "noun", arabic: "ندرة / قِلّة", definition: "An insufficient quantity or scarcity of something.", examples: ["The committee lamented the paucity of reliable data on climate impacts in the region.", "A paucity of qualified applicants forced the company to extend its hiring timeline.", "Scholars criticized the report for the paucity of primary sources supporting its claims."], synonyms: ["scarcity", "shortage", "dearth"], day: 38, group: 1 },
  { word: "penury", pos: "noun", arabic: "فقر مدقع / بؤس", definition: "Extreme poverty or destitution, often implying deprivation of basic needs.", examples: ["After losing his job and savings, he found himself plunged into penury and homelessness.", "The novel depicts the protagonist's descent into penury after a series of unfortunate events.", "Relief agencies work to alleviate penury by providing food, shelter, and medical aid."], synonyms: ["destitution", "poverty", "indigence"], day: 38, group: 1 },
  { word: "meager", pos: "adjective", arabic: "قليل / ضئيل", definition: "Lacking in quantity, quality, or extent; insufficient or scanty.", examples: ["The hikers survived on a meager supply of food until rescuers arrived.", "Despite her long tenure, she received only a meager raise that barely covered inflation.", "The report offered a meager analysis of the complex social issues at hand."], synonyms: ["scanty", "paltry", "sparse"], day: 38, group: 1 },
  { word: "indigent", pos: "adjective", arabic: "فقير / معدم", definition: "Lacking the basic necessities of life because of poverty; needy.", examples: ["The clinic provides free legal assistance to indigent families who cannot afford counsel.", "Local charities focus on housing solutions for indigent elderly citizens.", "During the economic crisis, many previously middle-class households became indigent."], synonyms: ["poor", "impoverished", "needy"], day: 38, group: 1 },
  { word: "destitute", pos: "adjective", arabic: "معدم / محروم", definition: "Without the basic necessities of life; utterly lacking resources or means of support.", examples: ["After the flood, entire neighborhoods were left destitute and in need of urgent aid.", "The charity's shelter offers services to destitute individuals seeking to rebuild their lives.", "He described a childhood so destitute that small acts of kindness seemed like miracles."], synonyms: ["impoverished", "penniless", "needy"], day: 38, group: 1 },
  { word: "thrifty", pos: "adjective", arabic: "موفّر / مقتصد", definition: "Careful and prudent in the use of resources or money; economical.", examples: ["Her thrifty habits allowed her to save for a down payment despite a modest salary.", "A thrifty approach to travel can make long journeys affordable without sacrificing comfort.", "The thrifty homeowner implemented simple repairs instead of costly replacements."], synonyms: ["economical", "prudent", "sparing"], day: 38, group: 1 },
  { word: "frugal", pos: "adjective", arabic: "مقتصد / متقشف", definition: "Avoiding waste and luxury; using resources sparingly and efficiently.", examples: ["They adopted a frugal lifestyle to pay off debt and build an emergency fund.", "A frugal meal prepared from seasonal produce can be both healthy and inexpensive.", "Her frugal choices did not prevent her from enjoying occasional treats with friends."], synonyms: ["economical", "sparing", "modest"], day: 38, group: 1 },
  { word: "pittance", pos: "noun", arabic: "مبلغ زهيد / أجر ضئيل", definition: "A very small or inadequate amount of money paid to someone as wage or allowance.", examples: ["The interns complained that they were expected to work long hours for a pittance.", "She donated most of her salary despite receiving only a pittance from her part-time job.", "Advocates argued that teachers should not be expected to live on such a pittance."], synonyms: ["trifle", "modicum", "paltry"], day: 38, group: 1 },
  { word: "miser", pos: "noun", arabic: "بخيل / شحيح", definition: "A person who hoards wealth and spends as little money as possible, often to an excessive degree.", examples: ["The old miser refused to donate even a small sum to the local hospital despite his wealth.", "Friends teased him for being a miser when he insisted on reusing paper towels to save pennies.", "The story's antagonist is a notorious miser whose stinginess affects everyone around him."], synonyms: ["skinflint", "cheapskate", "tightwad"], day: 38, group: 1 },
  { word: "scanty", pos: "adjective", arabic: "قليل / ضئيل", definition: "Insufficient in quantity or amount; meager.", examples: ["The report provided only scanty data, making it difficult to draw firm conclusions.", "She wore a scanty shawl on the cold evening and wished she had brought a coat.", "After the drought, the scanty rainfall failed to replenish the reservoirs."], synonyms: ["meager", "insufficient", "paltry"], day: 38, group: 2 },
  { word: "economical", pos: "adjective", arabic: "مقتصد / موفّر", definition: "Using resources (money, time, or materials) sparingly or efficiently; frugal.", examples: ["He drives an economical car that consumes very little fuel on long trips.", "The company adopted an economical approach to production to reduce waste and costs.", "Being economical with office supplies helped the department stay within budget."], synonyms: ["frugal", "thrifty", "cost-effective"], day: 38, group: 2 },
  { word: "sparing", pos: "adjective", arabic: "مقتصد / متحفظ", definition: "Using or giving only a small amount; restrained or moderate in use or allocation.", examples: ["She was sparing with her praise, reserving compliments for truly exceptional work.", "The chef used a sparing amount of salt so the natural flavors could shine.", "He was sparing in his comments during the meeting, preferring to listen rather than speak."], synonyms: ["frugal", "meager", "moderate"], day: 38, group: 2 },
  { word: "abstemious", pos: "adjective", arabic: "ممتنع / معتدل في الأكل", definition: "Characterized by self-denial or moderation, especially with regard to eating and drinking.", examples: ["Her abstemious habits made her a healthier eater than her indulgent friends.", "The monk led an abstemious life, avoiding excess and focusing on spiritual practice.", "To prepare for the competition he adopted an abstemious diet and rigorous training regimen."], synonyms: ["temperate", "self-disciplined", "moderate"], day: 38, group: 2 },
  { word: "mendicant", pos: "noun", arabic: "متسول / شحاذ", definition: "A beggar, especially one who lives by requesting charity.", examples: ["The mendicant sat at the market entrance hoping for coins from passersby.", "Medieval mendicant orders traveled from town to town relying on alms for food.", "Local charities try to assist mendicants with shelter and medical care rather than leave them on the street."], synonyms: ["beggar", "panhandler", "supplicant"], day: 38, group: 2 },
  { word: "privation", pos: "noun", arabic: "حرمان / افتقار", definition: "The state of being deprived of basic necessities or comforts of life; severe hardship.", examples: ["Prisoners endured years of privation with little food and minimal medical care.", "The explorers faced privation in the tundra when their supplies were delayed.", "Economic collapse led many families into privation as jobs vanished and savings evaporated."], synonyms: ["deprivation", "hardship", "penury"], day: 38, group: 2 },
  { word: "insolvent", pos: "adjective", arabic: "مفلس / معسر", definition: "Unable to pay debts owed; financially ruined or bankrupt.", examples: ["After several bad investments the company was declared insolvent and entered receivership.", "The bank closed accounts of an insolvent firm to prevent further losses.", "Facing mounting bills and no income, she feared she would soon be insolvent."], synonyms: ["bankrupt", "impecunious", "ruined"], day: 38, group: 2 },
  { word: "stingy", pos: "adjective", arabic: "بخيل / شحيح", definition: "Unwilling to give or spend; miserly and ungenerous.", examples: ["His stingy employer refused to give raises despite the company's strong profits.", "Guests complained about the stingy portions served at the restaurant's tasting menu.", "Don't be stingy with praise when a colleague does excellent work; encouragement matters."], synonyms: ["miserly", "parsimonious", "tightfisted"], day: 38, group: 2 },
  { word: "stint", pos: "noun", arabic: "حصة محدودة / فترة قصيرة", definition: "A fixed or limited period of time spent doing a particular job or activity, or a restricted allowance of work or resources.", examples: ["He served a two-year stint in the Peace Corps before returning to graduate school.", "Her brief stint as acting manager gave her valuable leadership experience.", "During his stint on the project he streamlined several inefficient procedures."], synonyms: ["period", "spell", "term"], day: 38, group: 2 },
  { word: "deplete", pos: "verb", arabic: "يستنزف / ينفد", definition: "To use up the supply or resources of; to reduce something greatly in quantity or number.", examples: ["Overfishing continues to deplete marine populations around the world.", "Long hikes in the heat quickly depleted their water reserves.", "Frequent withdrawals depleted the account and triggered an overdraft fee."], synonyms: ["exhaust", "drain", "consume"], day: 38, group: 2 },
  { word: "milk", pos: "verb", arabic: "يستغل / يستخلص", definition: "To exploit or extract something (often money or advantage) from someone or something, frequently in a selfish or opportunistic way.", examples: ["The promoter milked the scandal for weeks to keep attention on his client.", "Every morning the workers milk the herd before dawn to supply the dairy.", "She tried to milk the applause by taking an extra bow at the end of the concert."], synonyms: ["exploit", "extract", "squeeze"], day: 38, group: 3 },
  { word: "beg", pos: "verb", arabic: "يتوسل / يتسول", definition: "To ask someone earnestly or urgently for something, often out of desperation or need.", examples: ["He begged the judge for mercy during his sentencing hearing.", "Many people in the city are forced to beg on street corners to survive.", "I hate to beg, but could you lend me a few dollars until payday?"], synonyms: ["plead", "implore", "beseech"], day: 38, group: 3 },
  { word: "lucre", pos: "noun", arabic: "مال / كسب دنئ", definition: "Money, especially when regarded as sordid or gained by dishonorable means.", examples: ["The corrupt official was accused of seeking lucre rather than serving the public.", "She refused the lucre offered by the company because it would compromise her principles.", "Critics argued the director's latest film was driven by lucre rather than art."], synonyms: ["money", "profit", "gains"], day: 38, group: 3 },
  { word: "vanquished", pos: "adjective", arabic: "مهزوم / مغلوب", definition: "Thoroughly defeated or overcome in a contest, battle, or struggle.", examples: ["The vanquished army surrendered its weapons and retreated at dawn.", "Though politically vanquished, she continued to speak out for her causes.", "The novel ends with the vanquished hero learning to live in peace with his rivals."], synonyms: ["defeated", "conquered", "overcome"], day: 38, group: 3 },
  { word: "utopian", pos: "adjective", arabic: "طوباوي / مثالي غير واقعي", definition: "Pertaining to an idealized, perfect state or society, often impractical or unattainable in reality.", examples: ["His utopian blueprint for the city ignored basic economic constraints.", "The novel depicts a utopian community free of want and conflict.", "Many dismissed the reform as utopian and unlikely to succeed in practice."], synonyms: ["idealistic", "visionary", "impractical"], day: 38, group: 3 },
  { word: "usurp", pos: "verb", arabic: "ينتزع / يغتصب السلطة", definition: "To take a position of power or importance unlawfully or by force, or to seize control without right.", examples: ["The general attempted to usurp the presidency during the coup.", "She feared a rival would usurp her responsibilities and take credit for her work.", "The committee warned that no single department should usurp control of the budget."], synonyms: ["seize", "arrogate", "commandeer"], day: 38, group: 3 },
  { word: "usurious", pos: "adjective", arabic: "ربوي / فاحش الفائدة", definition: "Relating to or characterized by charging exorbitantly high or illegal interest rates on loans.", examples: ["Borrowers complained about the bank's usurious lending practices.", "The payday lender was fined for charging usurious fees to low-income customers.", "He denounced the contract's usurious terms as exploitative and unfair."], synonyms: ["extortionate", "exorbitant", "predatory"], day: 38, group: 3 },
  { word: "upbraided", pos: "verb", arabic: "وبخه / لامه", definition: "To scold or reproach someone severely for wrongdoing or poor performance.", examples: ["The coach upbraided the players for their lackluster performance after the defeat.", "She was upbraided by her manager for missing a critical deadline.", "Old letters showed how the teacher upbraided students for even minor infractions."], synonyms: ["scold", "rebuke", "chastise"], day: 38, group: 3 },
  { word: "unwieldy", pos: "adjective", arabic: "غير عملي / ضخم وثقيل", definition: "Difficult to manage, handle, or use because of bulkiness, complexity, or awkwardness.", examples: ["The unwieldy package required two people to carry it up the stairs.", "An unwieldy bureaucracy slowed the project to a crawl.", "She found the old database unwieldy compared with the new streamlined system."], synonyms: ["cumbersome", "bulky", "clumsy"], day: 38, group: 3 },
  { word: "hardscrabble", pos: "adjective", arabic: "قاسي الفقر / كدّ مرير", definition: "Characterized by poverty, hard work, and meager means; involving a difficult, frugal existence.", examples: ["He grew up in a hardscrabble town where families scraped together enough to survive.", "Their hardscrabble farm produced food but little profit.", "The memoir describes a hardscrabble childhood that taught resilience and thrift."], synonyms: ["impoverished", "meager", "austere"], day: 38, group: 3 },
  { word: "ample", pos: "adjective", arabic: "وفير / كافٍ", definition: "More than enough in size, amount, or scope.", examples: ["There was ample evidence to convict the defendant.", "She left ample time to catch the last train.", "The room offers ample storage for seasonal clothes."], synonyms: ["plentiful", "sufficient", "abundant"], day: 39, group: 1 },
  { word: "profusion", pos: "noun", arabic: "وفرة / كثرة", definition: "An abundance or large quantity of something, often to the point of excess.", examples: ["The garden produced a profusion of flowers in spring.", "He received a profusion of emails after the announcement.", "The artist used a profusion of color to evoke joy."], synonyms: ["abundance", "plethora", "excess"], day: 39, group: 1 },
  { word: "cornucopia", pos: "noun", arabic: "قرن الوفرة / وفرة كبيرة", definition: "A symbol or source of abundant supply; a plentiful, overflowing store.", examples: ["The farmer's market offered a cornucopia of fresh produce.", "Her research provides a cornucopia of examples supporting the theory.", "The holiday table was a cornucopia of traditional dishes."], synonyms: ["abundance", "profusion", "wealth"], day: 39, group: 1 },
  { word: "opulent", pos: "adjective", arabic: "فاخر / مترف", definition: "Demonstrating great wealth, luxury, or lavishness in appearance or style.", examples: ["They stayed in an opulent hotel suite with marble floors.", "The gala featured opulent decorations and couture gowns.", "Her opulent lifestyle attracted media attention."], synonyms: ["luxurious", "lavish", "sumptuous"], day: 39, group: 1 },
  { word: "plethora", pos: "noun", arabic: "فائض / وفرة زائدة", definition: "An excessive amount or overabundance of something.", examples: ["There is a plethora of online resources for learning code.", "The committee faced a plethora of proposals to review.", "He complained of a plethora of minor issues that slowed progress."], synonyms: ["overabundance", "excess", "surfeit"], day: 39, group: 1 },
  { word: "glut", pos: "noun", arabic: "فائض / فرط", definition: "A supply that exceeds demand; an oversupply leading to a surplus.", examples: ["A glut of oil on the market caused prices to fall.", "The restaurant industry faces a glut of delivery services competing for customers.", "After the harvest, there was a glut of tomatoes that farmers couldn't sell."], synonyms: ["surplus", "oversupply", "excess"], day: 39, group: 1 },
  { word: "myriad", pos: "adjective", arabic: "عدد لا يحصى / لا حصر له", definition: "Countless or extremely numerous; comprising a large and diverse number.", examples: ["The city offers myriad cultural attractions for visitors.", "She faced myriad challenges while building the startup.", "There are myriad reasons to support renewable energy adoption."], synonyms: ["countless", "numerous", "multitudinous"], day: 39, group: 1 },
  { word: "rife", pos: "adjective", arabic: "شائع / منتشر", definition: "Widespread or prevalent, often with a negative connotation of being full of something undesirable.", examples: ["Corruption was rife in the organization, leading to several arrests.", "Speculation about the merger was rife on social media.", "The coastline is rife with small fishing villages."], synonyms: ["widespread", "prevalent", "rampant"], day: 39, group: 1 },
  { word: "raft", pos: "noun", arabic: "عدد كبير / كثير", definition: "A large number or quantity of something, especially used informally.", examples: ["The policy change generated a raft of new regulations.", "She brought a raft of documents to the meeting for review.", "A raft of studies confirms the link between exercise and mental health."], synonyms: ["multitude", "host", "mass"], day: 39, group: 1 },
  { word: "slew", pos: "noun", arabic: "عدد كبير / عدد هائل", definition: "A large number or quantity of something, commonly used informally.", examples: ["The startup attracted a slew of investors during its seed round.", "She received a slew of compliments after her presentation.", "A slew of technical problems delayed the product launch."], synonyms: ["multitude", "host", "array"], day: 39, group: 1 },
  { word: "spate", pos: "noun", arabic: "سيل / فيضان", definition: "A large number or sudden outpouring of events or things, often of an unpleasant kind.", examples: ["A spate of break-ins in the neighborhood prompted residents to install better locks and security lights.", "After the announcement, the company received a spate of customer complaints about the new policy.", "The region experienced a spate of heavy rains that caused localized flooding and damaged crops."], synonyms: ["surge", "barrage", "flood"], day: 39, group: 2 },
  { word: "opulence", pos: "noun", arabic: "ترف / فخامة", definition: "The state of great wealth, luxury, and lavishness in surroundings or lifestyle.", examples: ["The palace's opulence was evident in its gilded ceilings and marble floors.", "She decorated her home with a taste for understated elegance rather than overt opulence.", "Films about the era often emphasize the opulence of high society and its extravagant parties."], synonyms: ["luxury", "lavishness", "affluence"], day: 39, group: 2 },
  { word: "unsavory", pos: "adjective", arabic: "غير مستساغ / مثير للاشمئزاز", definition: "Morally offensive, distasteful, or unpleasant in character or reputation.", examples: ["The politician's unsavory connections were exposed in an investigative report.", "He avoided the unsavory-looking stall at the market despite the low prices.", "The novel contains several unsavory scenes that some readers may find disturbing."], synonyms: ["distasteful", "reprehensible", "disreputable"], day: 39, group: 2 },
  { word: "unpretentiousness", pos: "noun", arabic: "تواضع / بساطة", definition: "The quality of being modest, simple, and not attempting to impress others.", examples: ["The restaurant's unpretentiousness was part of its charm; diners loved the simple, hearty food.", "Despite his fame, the artist's unpretentiousness made him approachable to students and fans.", "She admired the unpretentiousness of the village community, where people greeted each other warmly without formality."], synonyms: ["modesty", "humility", "simplicity"], day: 39, group: 2 },
  { word: "unkempt", pos: "adjective", arabic: "مهمل / غير مرتب", definition: "Having a messy or disheveled appearance; not properly maintained or cared for.", examples: ["He arrived at the meeting with unkempt hair and a wrinkled shirt, which surprised his colleagues.", "The garden had become unkempt after months of neglect, overrun with weeds and fallen branches.", "The landlord complained that tenants left the common areas unkempt and littered."], synonyms: ["untidy", "disheveled", "messy"], day: 39, group: 2 },
  { word: "uncultivated", pos: "adjective", arabic: "غير مزروع / غير مثقف", definition: "Not developed, grown, or refined; lacking agricultural development or cultural education.", examples: ["Much of the land remained uncultivated for years because it was rocky and difficult to farm.", "His uncultivated manners were at odds with the refined etiquette of the dinner guests.", "The region's uncultivated customs attracted anthropologists interested in traditional practices."], synonyms: ["unrefined", "uncultured", "primitive"], day: 39, group: 2 },
  { word: "unconventional", pos: "adjective", arabic: "غير تقليدي / مختلف", definition: "Not conforming to what is generally done or believed; breaking with tradition or norms.", examples: ["The architect is known for unconventional designs that challenge standard building forms.", "She pursued an unconventional career path, combining science with performance art.", "Their unconventional wedding included a tree-planting ceremony instead of a traditional reception."], synonyms: ["unorthodox", "atypical", "innovative"], day: 39, group: 2 },
  { word: "unassuming", pos: "adjective", arabic: "متواضع / غير متكبّر", definition: "Modest and not inclined to draw attention to oneself or boast about one's abilities.", examples: ["Despite her achievements, she remained unassuming and preferred to let her work speak for itself.", "He lived in an unassuming cottage that gave no hint of the collector's rare art inside.", "The unassuming teacher greeted each student with the same calm patience regardless of their background."], synonyms: ["humble", "modest", "reserved"], day: 39, group: 2 },
  { word: "tremulous", pos: "adjective", arabic: "مرتجف / مرتعش", definition: "Characterized by trembling or quivering, often from fear, nervousness, or weakness.", examples: ["Her tremulous voice betrayed how nervous she was before delivering the speech.", "The old man's hands were tremulous as he tried to steady the cup of tea.", "There was a tremulous hope in the crowd that the rescue team would arrive in time."], synonyms: ["shaky", "quivering", "timid"], day: 39, group: 2 },
  { word: "touted", pos: "verb", arabic: "مُروّج / مُمدَح", definition: "Publicly praised or promoted, often aggressively or excessively, to generate interest or approval.", examples: ["The startup touted its new app as a game-changer in personal finance management.", "He was touted as the heir apparent to the company, even though few knew his actual qualifications.", "Critics warned against products touted on social media without credible evidence of their benefits."], synonyms: ["promoted", "heralded", "praised"], day: 39, group: 2 },
  { word: "totalitarian", pos: "adjective", arabic: "استبدادي / شمولي", definition: "Relating to a system of government that centralizes authority in a single party or leader and demands complete subservience from the populace.", examples: ["The novel imagines a totalitarian state where private thought is monitored and punished.", "Management's totalitarian approach to decision-making stifled creativity across the department.", "Historians debate whether the movement's leaders intended to create a genuinely totalitarian bureaucracy or merely a highly centralized one."], synonyms: ["dictatorial", "authoritarian", "tyrannical"], day: 39, group: 3 },
  { word: "toothsome", pos: "adjective", arabic: "لذيذ / شهي", definition: "Pleasing to the taste; delicious, and often used to describe food that is appetizing or attractive.", examples: ["She served a toothsome tart that disappeared within minutes at the party.", "The restaurant is known for its toothsome pastries and inventive seasonal flavors.", "His toothsome description of the meal convinced me to try the chef's special."], synonyms: ["tasty", "delectable", "palatable"], day: 39, group: 3 },
  { word: "titular", pos: "adjective", arabic: "اسمي / شكلي", definition: "Holding a title or position in name only, without the usual powers or responsibilities, or relating to the title of a work or post.", examples: ["Although he was the titular head of the organization, real authority rested with the executive committee.", "The film's titular heroine undergoes a dramatic transformation by the final act.", "She retained the titular rank after retirement but performed none of the formal duties."], synonyms: ["nominal", "formal", "in-name-only"], day: 39, group: 3 },
  { word: "tensile", pos: "adjective", arabic: "قابل للشد / مطاطي", definition: "Relating to tension or the capacity of a material to withstand being stretched; often used when discussing strength under tension.", examples: ["Engineers tested the cable's tensile strength before approving it for the bridge.", "Modern polymers combine high tensile properties with low weight to improve performance.", "The report includes tensile measurements for each composite material under load."], synonyms: ["ductile", "stretchable", "pliant"], day: 39, group: 3 },
  { word: "taxonomic", pos: "adjective", arabic: "تصنيفي / تبويبي", definition: "Pertaining to the classification and organization of organisms, concepts, or items into a systematic framework.", examples: ["The biologists published a taxonomic revision that reclassified several species of beetles.", "Librarians rely on taxonomic principles to arrange materials so patrons can find them easily.", "Her taxonomic approach to the problem helped the team break it into manageable categories."], synonyms: ["classificatory", "systematic", "nomenclatural"], day: 39, group: 3 },
  { word: "flourish", pos: "verb", arabic: "يزدهر / يزهر", definition: "To grow or develop vigorously and successfully, often as the result of a favorable environment or conditions.", examples: ["After the policy change the small startup began to flourish, hiring new staff and expanding production.", "Classical music flourished in the city during the late nineteenth century due to increased patronage.", "With proper irrigation and sunlight, these native plants will flourish in your garden."], synonyms: ["thrive", "prosper", "bloom"], day: 39, group: 3 },
  { word: "swathe", pos: "verb", arabic: "يلف / يغطي", definition: "To wrap, envelop, or cover something completely with material or layers, or to surround and obscure it.", examples: ["Paramedics swathed the injured athlete's leg in bandages before transporting him to the hospital.", "By dawn the valley was swathed in a dense, impenetrable fog.", "The town was swathed in controversy after the revelations about the mayor's conduct."], synonyms: ["wrap", "envelop", "bandage"], day: 39, group: 3 },
  { word: "susceptible", pos: "adjective", arabic: "عرضة ل / قابل ل", definition: "Likely or liable to be influenced, affected, or harmed by a particular agent or condition.", examples: ["Elderly patients are especially susceptible to the complications of influenza.", "The committee warned that unvetted sources are susceptible to bias and misinformation.", "New technologies are often susceptible to unforeseen security vulnerabilities early in their adoption."], synonyms: ["vulnerable", "prone", "liable"], day: 39, group: 3 },
  { word: "surpassing", pos: "adjective", arabic: "متميز / فائق", definition: "Exceeding in degree or quality; exceptionally great or superior to others in some respect.", examples: ["Her performance demonstrated a surpassing skill that left even seasoned critics impressed.", "The athlete's surpassing speed made him a favorite to win the championship.", "He delivered a speech of surpassing eloquence that defined the tone of the campaign."], synonyms: ["exceptional", "outstanding", "unmatched"], day: 39, group: 3 },
  { word: "succumb", pos: "verb", arabic: "يستسلم / ينهزم", definition: "To give in to a stronger force, yield to temptation or pressure, or die from disease or injury.", examples: ["Under sustained interrogation many witnesses eventually succumbed to pressure and changed their testimony.", "After weeks of fighting the infection, the patient succumbed to complications.", "She tried to resist the offer but finally succumbed to the temptation of the prize."], synonyms: ["yield", "give in", "surrender"], day: 39, group: 3 },
  { word: "amuck", pos: "adverb", arabic: "بشكل هائج / بشكل جامح", definition: "In a frenzied, uncontrolled, or wildly disruptive manner.", examples: ["When the fireworks set off unexpectedly, the crowd ran amuck, trampling over the barricades.", "The ideas in his lecture ran amuck, jumping from history to philosophy without warning.", "After the power outage, teenagers ran amuck through the mall, playing pranks until security intervened."], synonyms: ["wildly", "frenziedly", "berserk"], day: 40, group: 1 },
  { word: "acrimony", pos: "noun", arabic: "مرارة / حدة في الكلام", definition: "Bitterness or sharpness of tone, manner, or feelings, often expressed in speech or behavior.", examples: ["The meeting ended with much acrimony, as both sides traded barbed remarks over the contract.", "Despite their shared history, discussions about money always generated acrimony between the siblings.", "Her resignation letter was written without acrimony, but the board still sensed an underlying resentment."], synonyms: ["bitterness", "hostility", "rancor"], day: 40, group: 1 },
  { word: "bilious", pos: "adjective", arabic: "سيء المزاج / صفراوي", definition: "Irritable or bad-tempered, or relating to an excess of bile and thus ill-natured or peevish.", examples: ["The critic's bilious review attacked the novel's style rather than engaging with its themes.", "He woke feeling bilious after a sleepless night and snapped at every question.", "The film's protagonist was portrayed as bilious and suspicious, which made him difficult to sympathize with."], synonyms: ["irritable", "choleric", "sullen"], day: 40, group: 1 },
  { word: "choleric", pos: "adjective", arabic: "سريع الغضب / حاد الطبع", definition: "Easily angered; characterized by a hot-tempered or irritable disposition.", examples: ["His choleric temperament made him a difficult manager, prone to sudden outbursts at minor mistakes.", "The choleric old man barked instructions at everyone, unwilling to listen to explanations.", "Even in the committee, her choleric responses alienated colleagues who preferred reasoned debate."], synonyms: ["irascible", "irritable", "testy"], day: 40, group: 1 },
  { word: "splenetic", pos: "adjective", arabic: "سريع الغضب / حاد الطباع", definition: "Marked by bad temper, spite, or irritable ill-humor; peevish and resentful.", examples: ["His splenetic comments revealed how deeply the slight had affected him.", "Despite the pleasant surroundings, her splenetic mood cast a shadow over the dinner party.", "The columnist's splenetic tone in the op-ed alienated many readers who expected a balanced analysis."], synonyms: ["spiteful", "irritable", "bilious"], day: 40, group: 1 },
  { word: "vitriolic", pos: "adjective", arabic: "لاذع / سام", definition: "Filled with bitter criticism or malice; caustic and scathing in tone.", examples: ["The senator's speech turned vitriolic as he attacked his opponent's character rather than policies.", "Their online exchange became vitriolic, with each comment more corrosive than the last.", "The book received vitriolic reviews from some critics who found its premise offensive."], synonyms: ["caustic", "scathing", "acrimonious"], day: 40, group: 1 },
  { word: "rancorous", pos: "adjective", arabic: "حاقد / مليء بالضغينة", definition: "Characterized by bitter, long-standing resentment or ill will toward someone or something.", examples: ["Years of betrayal produced a rancorous relationship that neither side could repair.", "Her rancorous tone during the deposition betrayed how deeply she had been wronged.", "The divorce proceedings became increasingly rancorous as old grievances were dredged up."], synonyms: ["resentful", "spiteful", "bitter"], day: 40, group: 1 },
  { word: "peevish", pos: "adjective", arabic: "سريع الزعل / متذمر", definition: "Easily irritated or annoyed, often by trivial matters; showing impatience or petulance.", examples: ["The child grew peevish after being asked to stand in line for too long.", "A peevish reply ended the conversation, making it clear she didn't want to be disturbed.", "He became peevish when the train was delayed and snapped at fellow commuters."], synonyms: ["irritable", "testy", "petulant"], day: 40, group: 1 },
  { word: "pique", pos: "verb", arabic: "يثير الاهتمام / يجرح كبرياء", definition: "To stimulate interest or curiosity, or to provoke resentment or wounded pride.", examples: ["The unusual premise of the novel piqued my curiosity, so I bought the book immediately.", "She was piqued by his offhand remark and refused to speak to him for the rest of the evening.", "The documentary's teaser was designed to pique viewers' interest without giving away the plot."], synonyms: ["provoke", "arouse", "irritate"], day: 40, group: 1 },
  { word: "nettle", pos: "verb", arabic: "يثير الغضب / يزعج", definition: "To annoy, irritate, or provoke someone, often causing a sharp, resentful response.", examples: ["Her casual criticism nettled him, and he spent the afternoon stewing over the remark.", "The constant background noise from the construction site nettled residents who worked from home.", "He knew better than to nettle the boss with questions during the tense budget meeting."], synonyms: ["irritate", "annoy", "provoke"], day: 40, group: 1 },
  { word: "vex", pos: "verb", arabic: "يزعج / يغيظ", definition: "to cause annoyance, frustration, or distress, often by persistent or puzzling trouble.", examples: ["The constant drip from the faucet began to vex her during the midnight study session.", "He was vexed by the ambiguous instructions on the exam and kept rereading the question.", "Her colleague's habit of interrupting meetings continued to vex the entire team."], synonyms: ["annoy", "irritate", "disturb"], day: 40, group: 2 },
  { word: "irk", pos: "verb", arabic: "يُضايق / يزعج", definition: "to bother or irritate someone slightly; to cause annoyance.", examples: ["It irks me when people chew loudly during a quiet lecture.", "The minor formatting errors in the report irked the manager more than he expected.", "She didn't mean to irk him, but her blunt question touched a sore spot."], synonyms: ["annoy", "bother", "irritate"], day: 40, group: 2 },
  { word: "incense", pos: "verb", arabic: "يغضب بشدة / يسخط", definition: "to make someone extremely angry or indignant.", examples: ["The CEO was incensed by the revelation of financial mismanagement and demanded an immediate audit.", "His casual dismissal of their concerns incensed the neighborhood activists.", "She was incensed, storming out of the meeting after hearing the accusation."], synonyms: ["infuriate", "enrage", "anger"], day: 40, group: 2 },
  { word: "exasperate", pos: "verb", arabic: "يسخط / يثير الغضب", definition: "to irritate or frustrate someone intensely, especially through repeated provocation or obstruction.", examples: ["The slow progress on the project exasperated the client until he demanded a new team.", "Her younger brother's constant questions exasperated her during the long drive.", "Attempts to clarify the policy only seemed to exasperate the committee members further."], synonyms: ["irritate", "infuriate", "annoy"], day: 40, group: 2 },
  { word: "bristle", pos: "verb", arabic: "يستشيط غضبًا / يقشعر", definition: "to react defensively or angrily, often showing visible signs of irritation or tension.", examples: ["He bristled at the suggestion that he had cheated on the exam.", "The dog bristled when strangers approached the fence, its hackles rising.", "She bristled with indignation when her professional competence was questioned."], synonyms: ["resent", "flare", "stiffen"], day: 40, group: 2 },
  { word: "rankle", pos: "verb", arabic: "يثير الضغينة / يوجع القلب", definition: "to cause persistent annoyance, resentment, or irritation that lingers over time.", examples: ["The unfair promotion continued to rankle him long after it was announced.", "Her offhand remark rankedled in his mind and affected his presentation that week.", "Old grievances can rankle in a community and impede reconciliation efforts."], synonyms: ["fester", "irritate", "annoy"], day: 40, group: 2 },
  { word: "surly", pos: "adjective", arabic: "عابس / وقح", definition: "bad-tempered, unfriendly, and somewhat rude in demeanor.", examples: ["The surly attendant refused to answer any of the passengers' polite questions.", "He gave a surly shrug and turned away without explaining his decision.", "Despite the festival atmosphere, the security guard remained surly and withdrawn."], synonyms: ["sullen", "gruff", "rude"], day: 40, group: 2 },
  { word: "cantankerous", pos: "adjective", arabic: "صعب المراس / مشاكس", definition: "difficult to deal with because of a bad-tempered, argumentative, or uncooperative nature.", examples: ["The cantankerous neighbor complained about the lawn every season, no matter how well it was kept.", "Even the most patient nurse found the cantankerous patient challenging to calm.", "He became cantankerous in his later years, often snapping at friends and relatives for minor offenses."], synonyms: ["ornery", "cranky", "irritable"], day: 40, group: 2 },
  { word: "querulous", pos: "adjective", arabic: "متذمّر / شاكٍ", definition: "habitually complaining in a whining or petulant manner.", examples: ["The querulous customer demanded refunds for trivial imperfections in the product.", "He answered her querulous questions with forced patience during the entire interview.", "The child's querulous tone made the teacher less inclined to offer extra help."], synonyms: ["complaining", "petulant", "whining"], day: 40, group: 2 },
  { word: "apoplectic", pos: "adjective", arabic: "مستشيط غضبًا / غاضب جدًا", definition: "overcome with anger to the point of being nearly unable to act or speak; extremely furious.", examples: ["When he saw the damage to his car, he went apoplectic and immediately called the police.", "The apoplectic coach berated the referees in a tirade that lasted several minutes.", "Her father was apoplectic at the suggestion that she might drop out of college."], synonyms: ["furious", "enraged", "livid"], day: 40, group: 2 },
  { word: "incensed", pos: "adjective", arabic: "غاضب / ساخط", definition: "Extremely angry or enraged, especially in response to something perceived as unjust.", examples: ["She was incensed when she learned the committee had reversed its decision without explanation.", "The customers were incensed by the sudden price hike and flooded the company with complaints.", "He wrote an incensed letter to the editor after reading the misleading article."], synonyms: ["furious", "enraged", "irate"], day: 40, group: 3 },
  { word: "glower", pos: "verb", arabic: "يعبس / يحدق بغضب", definition: "To stare angrily or sullenly, often expressing disapproval or hostility.", examples: ["The coach glowered at the referee after the controversial call and was warned with a yellow card.", "She glowered from across the room, clearly displeased with the conversation she overheard.", "When the children misbehaved, their grandmother would glower until they quieted down."], synonyms: ["glare", "scowl", "frown"], day: 40, group: 3 },
  { word: "rile", pos: "verb", arabic: "يزعج / يثير الغضب", definition: "To make someone annoyed, irritated, or angry.", examples: ["His offhand remarks about the project riled his teammates and delayed progress.", "The constantly dripping faucet began to rile everyone in the apartment building.", "She tried not to rile her boss with unnecessary questions during the meeting."], synonyms: ["irritate", "annoy", "vex"], day: 40, group: 3 },
  { word: "subsidy", pos: "noun", arabic: "دعم مالي / إعانة حكومية", definition: "Financial assistance given by a government or organization to support an economic activity or reduce costs.", examples: ["The farmers relied on a government subsidy to offset the costs of expensive fertilizers.", "Critics argued that the subsidy distorted the market and discouraged innovation.", "The renewable energy startup secured a subsidy that allowed it to scale production more quickly."], synonyms: ["grant", "aid", "assistance"], day: 40, group: 3 },
  { word: "subsequent", pos: "adjective", arabic: "لاحق / تالٍ", definition: "Occurring or coming later in time; following an event or sequence.", examples: ["Subsequent studies confirmed the initial findings and strengthened the proposed theory.", "The errors in the first draft were corrected in subsequent revisions of the manuscript.", "His actions in the subsequent months suggested a change in priorities."], synonyms: ["ensuing", "following", "succeeding"], day: 40, group: 3 },
  { word: "stupefied", pos: "adjective", arabic: "مندهش / مصدوم", definition: "So astonished or shocked that one is unable to think or react normally; stunned.", examples: ["She stood stupefied at the gallery opening when she saw her painting featured on the main wall.", "The students were stupefied by the complexity of the final exam questions.", "He was left stupefied after hearing the unexpected verdict in court."], synonyms: ["astonished", "stunned", "bewildered"], day: 40, group: 3 },
  { word: "streamlined", pos: "adjective", arabic: "مبسّط / انسيابي", definition: "Designed or organized to be efficient and simple, often by removing unnecessary elements or smoothing form to reduce resistance.", examples: ["The company adopted a streamlined workflow that cut processing time in half.", "The new train has a more streamlined shape to reduce wind resistance and improve speed.", "After the merger they created a streamlined management structure to eliminate redundancies."], synonyms: ["efficient", "simplified", "sleek"], day: 40, group: 3 },
  { word: "storied", pos: "adjective", arabic: "مشهور / ذو تاريخ", definition: "Having been celebrated or notable in history or traditional accounts; famous for a remarkable past.", examples: ["The storied university has produced numerous Nobel laureates and influential leaders.", "They toured a storied vineyard that had been producing wine for over three centuries.", "The playwright drew on the storied past of the city to craft his drama."], synonyms: ["legendary", "celebrated", "renowned"], day: 40, group: 3 },
  { word: "stigmas", pos: "noun", arabic: "وصمة عار / سُمعة سيئة", definition: "Marks of disgrace or negative associations attached to a person, condition, or circumstance.", examples: ["Despite progress, stigmas around mental illness still deter many from seeking help.", "Former convicts often face stigmas that make finding employment difficult after release.", "Public health campaigns aim to reduce the stigmas associated with certain diseases."], synonyms: ["shame", "disgrace", "taint"], day: 40, group: 3 },
  { word: "statuesque", pos: "adjective", arabic: "طويل القامة / مهيب", definition: "Attractively tall and dignified in appearance, like a statue.", examples: ["She had a statuesque presence on the runway that commanded the audience's attention.", "The actress's statuesque posture and serene expression made her ideal for period roles.", "He admired the statuesque cypress trees lining the avenue as they walked through the park."], synonyms: ["elegant", "majestic", "graceful"], day: 40, group: 3 },
  { word: "becalm", pos: "verb", arabic: "يهدئ / يسكّن", definition: "To make calm or still, especially by removing agitation or disturbance.", examples: ["The captain’s steady voice becalmed the anxious crew as the storm approached.", "A lull in the wind becalmed the yacht for several hours.", "Her presence seemed to becalm everyone in the tense meeting."], synonyms: ["calm", "soothe", "pacify"], day: 41, group: 1 },
  { word: "quell", pos: "verb", arabic: "يقمع / يهدئ / يخمد", definition: "To put an end to something, often by force, or to suppress strong emotions or disturbances.", examples: ["Authorities moved quickly to quell the protests before they turned violent.", "She took deep breaths to quell the panic rising in her chest.", "The manager instituted new policies to quell recurring disputes among staff."], synonyms: ["suppress", "subdue", "quash"], day: 41, group: 1 },
  { word: "serenity", pos: "noun", arabic: "صفاء / سكينة", definition: "The quality or state of being calm, peaceful, and untroubled.", examples: ["He sought the serenity of the countryside after months of urban chaos.", "The photograph captures the serenity of a foggy lakeshore at dawn.", "Daily meditation helped her recover a sense of inner serenity."], synonyms: ["tranquility", "calmness", "peacefulness"], day: 41, group: 1 },
  { word: "halcyon", pos: "adjective", arabic: "هادئ / أيام رخاء", definition: "Describing a past period that was idyllically peaceful and happy.", examples: ["She fondly recalled the halcyon days of her childhood summers at the beach.", "The company nostalgically marketed products as reminders of a halcyon era of prosperity.", "After the merger, employees talked about returning to halcyon times when the office felt more relaxed."], synonyms: ["tranquil", "golden", "peaceful"], day: 41, group: 1 },
  { word: "conciliate", pos: "verb", arabic: "يصالح / يهدئ / يرضي", definition: "To gain goodwill or favor by pleasing acts; to reconcile or make compatible.", examples: ["The mediator worked tirelessly to conciliate the two sides and reach an agreement.", "He offered a sincere apology to conciliate his estranged colleague.", "Small concessions were used to conciliate public opinion and calm unrest."], synonyms: ["placate", "reconcile", "appease"], day: 41, group: 1 },
  { word: "sedentary", pos: "adjective", arabic: "قليل الحركة / جلوسي", definition: "Characterized by much sitting and little physical activity.", examples: ["A sedentary lifestyle can contribute to a variety of health problems over time.", "Her doctor recommended breaking up long, sedentary stretches with short walks.", "Many modern jobs are sedentary, requiring ergonomics and regular exercise breaks."], synonyms: ["inactive", "stationary", "deskbound"], day: 41, group: 1 },
  { word: "sedative", pos: "noun", arabic: "مُهدئ / مهدئ طبي", definition: "A substance that calms or induces sleep by depressing the central nervous system.", examples: ["The physician prescribed a mild sedative to help the patient sleep through the night.", "The slow, repetitive music acted as a sedative, lulling the audience to relaxation.", "They warned him not to drive while taking the sedative prescribed after surgery."], synonyms: ["tranquilizer", "calmative", "soother"], day: 41, group: 1 },
  { word: "composure", pos: "noun", arabic: "اتزان / رباطة جأش", definition: "The state of being calm, self-possessed, and in control of one's emotions.", examples: ["She maintained her composure throughout the heated debate.", "His composure under pressure impressed the entire team during the crisis.", "Losing composure at that critical moment cost him the opportunity."], synonyms: ["calmness", "self-control", "equanimity"], day: 41, group: 1 },
  { word: "sangfroid", pos: "noun", arabic: "رباطة جأش / هدوء أعصاب", definition: "Composure or coolness, especially shown in difficult or dangerous situations.", examples: ["She handled the emergency with astonishing sangfroid, directing others calmly and efficiently.", "The surgeon's sangfroid reassured the family during the long operation.", "Negotiators must maintain sangfroid when tensions rise at the bargaining table."], synonyms: ["composure", "poise", "calmness"], day: 41, group: 1 },
  { word: "unflappable", pos: "adjective", arabic: "لا ينزعج / هادئ الأعصاب", definition: "Not easily upset or perturbed; remaining calm in stressful situations.", examples: ["The unflappable news anchor continued delivering the report despite the studio power outage.", "Her unflappable manner makes her the ideal project leader during crises.", "Even when the schedule collapsed, he stayed unflappable and found a solution."], synonyms: ["calm", "collected", "imperturbable"], day: 41, group: 1 },
  { word: "staple", pos: "noun", arabic: "عنصر أساسي / سلعة أساسية", definition: "A principal item or commodity regularly used or produced, forming a basic or essential part of something.", examples: ["Rice is a staple in many Asian diets and appears at nearly every meal.", "Textbooks remain the staple of the course, despite the availability of online resources.", "Wool and flax were staples of the regional economy in the pre-industrial era."], synonyms: ["mainstay", "essential", "basic"], day: 41, group: 2 },
  { word: "solipsistic", pos: "adjective", arabic: "متمحور حول الذات / أناني فكري", definition: "Exhibiting an extreme preoccupation with oneself and one's own experiences to the exclusion or dismissal of others' perspectives.", examples: ["His solipsistic arguments ignored the broader social context and focused only on his own sensations.", "A solipsistic narrator makes it difficult for readers to trust any account beyond the protagonist's inner world.", "Critics accused the philosopher of a solipsistic outlook that could not account for interpersonal knowledge."], synonyms: ["self-centered", "egocentric", "narcissistic"], day: 41, group: 2 },
  { word: "skulk", pos: "verb", arabic: "يتسلل / يختبئ", definition: "To move stealthily or furtively, often with the intent to avoid notice or arouse suspicion.", examples: ["The cat skulked around the garden until it found a place to pounce.", "He was accused of skulking through the office late at night to steal confidential files.", "Local residents reported seeing someone skulking near the school during the evening hours."], synonyms: ["sneak", "lurk", "prowl"], day: 41, group: 2 },
  { word: "skulduggery", pos: "noun", arabic: "مكائد / حيلة خبيثة", definition: "Underhanded or unscrupulous behavior; trickery or deceptive practices used to achieve an end.", examples: ["The investigation uncovered financial skulduggery at the highest levels of the company.", "Political skulduggery during the campaign eroded public trust in both parties.", "Her memoir exposed the skulduggery that had allowed the scheme to operate for years."], synonyms: ["deceit", "trickery", "chicanery"], day: 41, group: 2 },
  { word: "shelve", pos: "verb", arabic: "يؤجل / يضع على الرف", definition: "To put aside or postpone indefinitely; to place something on a shelf for storage or later consideration.", examples: ["The committee voted to shelve the proposal until more data could be collected.", "After the prototype failed safety tests, the engineers decided to shelve the project.", "She shelved the old paperwork in a box and labeled it for archival review next year."], synonyms: ["postpone", "defer", "table"], day: 41, group: 2 },
  { word: "self-styled", pos: "adjective", arabic: "المسمى بنفسه / يدّعي لنفسه", definition: "Describing someone who gives themselves a particular title or characterization, often without formal recognition or authority.", examples: ["The self-styled guru attracted followers with grand promises but little verifiable expertise.", "She is a self-styled expert on urban gardening, teaching workshops in her neighborhood.", "The magazine ran a profile of a self-styled philanthropist whose claims were later disputed."], synonyms: ["self-proclaimed", "so-called", "self-declared"], day: 41, group: 2 },
  { word: "segue", pos: "noun", arabic: "انتقال سلس / تحول سلس", definition: "A smooth transition from one topic, section, or scene to another without interruption or abrupt change.", examples: ["The host used a clever segue to move from the technical presentation to the audience Q&A.", "There was a natural segue between the opening monologue and the first interview segment.", "The film's soundtrack provided a gentle segue that bridged the two contrasting scenes."], synonyms: ["transition", "shift", "link"], day: 41, group: 2 },
  { word: "sectarian", pos: "adjective", arabic: "طائفي / تعصبي", definition: "Relating to or arising from sects and their conflicts, often marked by narrow allegiance and intolerance toward other groups.", examples: ["Sectarian violence destabilized the region and made reconciliation efforts difficult.", "The debate devolved into sectarian squabbling rather than a substantive discussion of policy.", "Academics warned that sectarian rhetoric could inflame already fragile community relations."], synonyms: ["partisan", "factional", "dogmatic"], day: 41, group: 2 },
  { word: "secretes", pos: "verb", arabic: "يفرز / يطلق", definition: "Releases or emits a substance, especially from a gland or cell, as part of a biological or chemical process.", examples: ["The pancreas secretes insulin in response to rising blood sugar levels.", "When threatened, the skunk secretes a foul-smelling spray as a defense mechanism.", "Certain immune cells secrete signaling molecules that recruit other cells to the site of infection."], synonyms: ["emits", "exudes", "produces"], day: 41, group: 2 },
  { word: "scuttle", pos: "verb", arabic: "يهرول / يغرق السفينة", definition: "To move quickly with short, hurried steps, or to deliberately sink a vessel or bring something to an abrupt end.", examples: ["The children scuttled across the playground when the rain began to fall.", "The crew made the painful decision to scuttle the damaged ship rather than let it be captured.", "Budget constraints scuttled the committee's plans for a summer festival."], synonyms: ["scoot", "scram", "sink"], day: 41, group: 2 },
  { word: "scuffle", pos: "noun", arabic: "شجار / مناوشة", definition: "A short, disorderly fight or struggle, typically involving a few people and little serious harm.", examples: ["A scuffle broke out between two fans near the stadium exit after the game.", "The witness described the scuffle as brief but chaotic, with chairs overturned.", "Security stepped in quickly to break up the scuffle before anyone was seriously injured."], synonyms: ["brawl", "fracas", "tussle"], day: 41, group: 3 },
  { word: "scrutinize", pos: "verb", arabic: "يفحص بدقة / يدقق", definition: "To examine or inspect closely and thoroughly, especially in a critical or careful way.", examples: ["The auditors will scrutinize the company's financial records for any irregularities.", "She scrutinized the contract before signing, looking for hidden clauses.", "Researchers scrutinize the data to ensure the results are statistically significant."], synonyms: ["examine", "inspect", "analyze"], day: 41, group: 3 },
  { word: "scotch", pos: "verb", arabic: "يقضي على / يُبطل", definition: "To put an end to something decisively or to prevent it from succeeding.", examples: ["The committee issued a statement to scotch rumors about the CEO's resignation.", "He moved quickly to scotch the deal after discovering the fraudulent documents.", "A strong rebuttal from the candidate scotched speculation about a scandal."], synonyms: ["quash", "squelch", "suppress"], day: 41, group: 3 },
  { word: "scofflaw", pos: "noun", arabic: "مخالف للقانون / منتهك للقواعد", definition: "A person who habitually violates laws, rules, or regulations, especially minor ones like parking or tax rules.", examples: ["The city introduced tougher fines to deter parking scofflaws who ignored the meters.", "As a scofflaw, he routinely filed his taxes late and faced repeated penalties.", "Campaigners criticized the government for being lenient with corporate scofflaws."], synonyms: ["lawbreaker", "delinquent", "offender"], day: 41, group: 3 },
  { word: "sclerotic", pos: "adjective", arabic: "متصلب / جامد", definition: "Becoming rigid, inflexible, or slow to change, often describing institutions or tissues that have hardened.", examples: ["Many critics argued that the sclerotic bureaucracy blocked necessary reforms.", "The disease left parts of the nervous system sclerotic and impaired mobility.", "A sclerotic board of directors resisted the innovative proposals from younger staff."], synonyms: ["rigid", "ossified", "hardened"], day: 41, group: 3 },
  { word: "scapegoat", pos: "noun", arabic: "كبش فداء / ضحية مبررة", definition: "Someone who is unfairly blamed for problems or misdeeds, allowing others to avoid responsibility.", examples: ["Rather than address systemic failures, management found a scapegoat to fire.", "Immigrants were made the scapegoats for the town's economic decline.", "She refused to be the scapegoat for the team's mistakes and demanded a transparent review."], synonyms: ["fall guy", "patsy", "dupe"], day: 41, group: 3 },
  { word: "satiated", pos: "adjective", arabic: "مشبع / شبعان", definition: "Fully satisfied, especially in terms of hunger or desire, to the point of having no further need or appetite.", examples: ["After the five-course meal he felt completely satiated and could not eat another bite.", "Her curiosity was briefly satiated by the explanation, but she soon wanted more details.", "The company's market share left it satiated with short-term profits but hungry for innovation."], synonyms: ["sated", "satisfied", "contented"], day: 41, group: 3 },
  { word: "sapid", pos: "adjective", arabic: "لذيذ الطعم / ذو مذاق", definition: "Having a strong, pleasant flavor; flavorful or palatable.", examples: ["The chef's new sauce was unexpectedly sapid, drawing praise from diners.", "The old cookbook promised sapid stews that would please even picky eaters.", "Though the fruit looked ordinary, it tasted sapid and aromatic."], synonyms: ["tasty", "flavorful", "palatable"], day: 41, group: 3 },
  { word: "saccharine", pos: "adjective", arabic: "مفرط الحلاوة / مصطنع المشاعر", definition: "Excessively sweet or sentimental in a way that seems insincere or cloying.", examples: ["The film's ending was so saccharine that many viewers found it unrealistic.", "She disliked the saccharine tone of the advertisement and preferred a more honest approach.", "Their saccharine public statements did little to reassure the skeptical electorate."], synonyms: ["insincere", "cloying", "sentimental"], day: 41, group: 3 },
  { word: "ruffian", pos: "noun", arabic: "بلطجي / منحرف", definition: "A violent or lawless person who behaves in a brutal, rowdy, or criminal manner.", examples: ["A gang of ruffians smashed the shop windows during the unrest.", "He refused to be intimidated by the ruffian lurking at the alley's entrance.", "The novel's antagonist is a ruthless ruffian who terrorizes the village."], synonyms: ["thug", "bully", "hoodlum"], day: 41, group: 3 },
  { word: "accolade", pos: "noun", arabic: "تقدير / تكريم", definition: "A formal expression of praise or an award recognizing notable achievement.", examples: ["She received an accolade from the university for her groundbreaking research.", "The film collected numerous accolades at international festivals this year.", "His colleagues presented him with an accolade at the staff meeting for his mentorship."], synonyms: ["praise", "honor", "award"], day: 42, group: 1 },
  { word: "adulation", pos: "noun", arabic: "إطراء مفرط / مديح زائد", definition: "Excessive or insincere praise, often lavished to gain favor.", examples: ["The celebrity grew weary of the constant adulation that followed every public appearance.", "Campaign aides were wary of the politician's susceptibility to adulation from supporters.", "Her modesty made her uncomfortable with the adulation she received after the lecture."], synonyms: ["flattery", "fawning", "idolization"], day: 42, group: 1 },
  { word: "encomium", pos: "noun", arabic: "مديح رسمي / ثناء بالغ", definition: "A formal speech or written piece that offers high praise for someone or something.", examples: ["The retiring coach was honored with an encomium that traced his long career.", "The critic's essay reads like an encomium to the painter's late period.", "The program booklet contained an encomium from a former student praising the professor's influence."], synonyms: ["eulogy", "panegyric", "tribute"], day: 42, group: 1 },
  { word: "eulogy", pos: "noun", arabic: "مرثية / كلمة تأبينية", definition: "A speech or piece of writing that praises someone who has recently died, typically delivered at a funeral.", examples: ["She delivered a moving eulogy that captured her father's generosity and humor.", "The eulogy focused on his lifelong commitment to community service.", "After writing the eulogy, he felt more at peace with the loss."], synonyms: ["oration", "tribute", "encomium"], day: 42, group: 1 },
  { word: "panegyric", pos: "noun", arabic: "مديح مطلق / خطاب مدح", definition: "A lofty or elaborate expression of praise, often in the form of a formal speech or text.", examples: ["The speaker delivered a panegyric celebrating the founder's visionary leadership.", "The magazine's profile functioned more as a panegyric than a critical assessment.", "At the gala, each accolade was accompanied by a short panegyric from a colleague."], synonyms: ["encomium", "eulogy", "tribute"], day: 42, group: 1 },
  { word: "revere", pos: "verb", arabic: "يوقر / يجل", definition: "To feel deep respect, admiration, or devotion toward someone or something.", examples: ["Many generations revere the founder as a symbol of perseverance and integrity.", "She reveres her grandmother's cooking and tries to recreate the recipes.", "Scientists around the world revere the work that transformed the field."], synonyms: ["respect", "venerate", "honor"], day: 42, group: 1 },
  { word: "exalt", pos: "verb", arabic: "يمجد / يرفع", definition: "To praise highly or to elevate in rank, status, or importance.", examples: ["The committee exalted her contributions during the award ceremony.", "Romantic poets often exalt love as the highest human experience.", "Critics warned that the policy would exalt private profits over public good."], synonyms: ["praise", "elevate", "glorify"], day: 42, group: 1 },
  { word: "laud", pos: "verb", arabic: "يمدح / يشيد بـ", definition: "To praise someone or something highly, especially in public.", examples: ["Reviewers lauded the novel for its original narrative voice.", "The board lauded the research team's innovative approach to the problem.", "She was lauded for making an ethically sound decision under pressure."], synonyms: ["praise", "extol", "commend"], day: 42, group: 1 },
  { word: "homage", pos: "noun", arabic: "تكريم / احترام", definition: "Public honor or respect shown to someone, often acknowledging their influence or achievements.", examples: ["The director's latest film is an homage to classic noir cinema.", "They paid homage to the founder with a well-attended dedication ceremony.", "The concert ended with a piece played in homage to the late composer."], synonyms: ["tribute", "respect", "salute"], day: 42, group: 1 },
  { word: "kudos", pos: "noun", arabic: "ثناء / تقدير", definition: "Praise, acclaim, or recognition given for an achievement.", examples: ["Kudos to the volunteers who coordinated the disaster relief efforts.", "She earned kudos from colleagues for resolving the crisis efficiently.", "While seeking kudos can motivate some, the team focused on long-term impact."], synonyms: ["praise", "credit", "acclaim"], day: 42, group: 1 },
  { word: "plaudits", pos: "noun", arabic: "تصفيق / استحسان", definition: "Expressions of praise or approval, especially public acclaim for an achievement.", examples: ["The playwright received plaudits from critics and audiences alike after the premiere.", "Her research earned plaudits from colleagues across the discipline.", "Despite initial skepticism, the new program won plaudits for its measurable results."], synonyms: ["praise", "acclaim", "applause"], day: 42, group: 2 },
  { word: "commendable", pos: "adjective", arabic: "جدير بالثناء / مستحق التقدير", definition: "Worthy of praise and approval because of admirable or meritorious qualities or actions.", examples: ["Her dedication to mentoring undergraduates is truly commendable.", "The committee described the candidate's initiative as commendable given the limited resources.", "It was commendable that he accepted responsibility and worked to make amends."], synonyms: ["praiseworthy", "laudable", "admirable"], day: 42, group: 2 },
  { word: "paean", pos: "noun", arabic: "نشيد مدح / أنشودة ثناء", definition: "A song, poem, or expression that enthusiastically praises or celebrates someone or something.", examples: ["The critic's review read like a paean to the novelist's imaginative powers.", "At the ceremony, colleagues offered a paean to her decades of public service.", "The documentary ended with a paean to the unsung heroes of the movement."], synonyms: ["ode", "eulogy", "tribute"], day: 42, group: 2 },
  { word: "renowned", pos: "adjective", arabic: "مشهور / معروف", definition: "Widely known and highly respected for excellence or notable achievements.", examples: ["She is a renowned scientist whose work changed the field's approach to the problem.", "The region is renowned for its vineyards and culinary traditions.", "Renowned architects were invited to design the new cultural center."], synonyms: ["famous", "celebrated", "distinguished"], day: 42, group: 2 },
  { word: "rotund", pos: "adjective", arabic: "ممتلئ الجسد / مستدير", definition: "Having a full, rounded shape; often used to describe a plump figure or a rich, rounded voice.", examples: ["The rotund professor laughed heartily as he entered the lecture hall.", "The announcer's rotund voice carried easily across the stadium.", "Despite his rotund build, he moved with surprising agility during the dance."], synonyms: ["round", "plump", "portly"], day: 42, group: 2 },
  { word: "risque", pos: "adjective", arabic: "جريء جنسياً / فاضح", definition: "Slightly indecent or sexually suggestive in a way that may be considered improper.", examples: ["The comedian's set became increasingly risque as the night progressed.", "She chose a risque outfit that drew attention at the conservative fundraiser.", "The film received mixed reviews for its artistic merits and its risque content."], synonyms: ["indecent", "suggestive", "salacious"], day: 42, group: 2 },
  { word: "risible", pos: "adjective", arabic: "مضحك / مثير للسخرية", definition: "So absurd or ridiculous as to provoke laughter or derision.", examples: ["The politician's explanation was so risible that it only worsened public perception.", "His risible attempt at mimicry had the entire class in stitches.", "The magazine mocked the risible claims made in the advertisement."], synonyms: ["laughable", "absurd", "ridiculous"], day: 42, group: 2 },
  { word: "riposte", pos: "noun", arabic: "رد سريع / رد مباغت", definition: "A quick, clever reply or retaliatory action, especially in verbal exchange or fencing.", examples: ["She delivered a sharp riposte that left her interlocutor speechless.", "The editorial offered a pointed riposte to the earlier accusations.", "In fencing, a successful riposte must be executed immediately after a parry."], synonyms: ["retort", "rejoinder", "counter"], day: 42, group: 2 },
  { word: "revulsion", pos: "noun", arabic: "اشمئزاز شديد / نفور", definition: "An intense feeling of disgust or repugnance that causes emotional withdrawal or rejection.", examples: ["She felt revulsion at the graphic details described in the report.", "Public revulsion over the scandal led to calls for reform.", "His revulsion toward the idea made further debate impossible."], synonyms: ["disgust", "abhorrence", "repugnance"], day: 42, group: 2 },
  { word: "zeitgeist", pos: "noun", arabic: "روح العصر / طابع العصر", definition: "The characteristic spirit, mood, or intellectual climate of a particular period in history.", examples: ["The novel captured the zeitgeist of the 1960s with uncanny accuracy.", "Designers often try to anticipate the zeitgeist rather than simply follow it.", "Optimism about technology is a prominent element of the current zeitgeist."], synonyms: ["spirit of the age", "spirit", "mood"], day: 42, group: 2 },
  { word: "reverberate", pos: "verb", arabic: "يتردد / يصدر صدى", definition: "To echo or resound, and by extension to have a continuing or widespread effect or influence.", examples: ["The sound of the church bells reverberated through the valley for several minutes.", "Her controversial remarks reverberated across the media and reshaped the public debate.", "Decades later, the policy decisions of that era continue to reverberate in current economic inequality."], synonyms: ["resound", "echo", "ring"], day: 42, group: 3 },
  { word: "revanche", pos: "noun", arabic: "الرغبة في الانتقام / استرداد الأراضي", definition: "A political or social desire for revenge or for the recovery of lost territory, status, or prestige.", examples: ["After the territorial defeat, a mood of revanche swept through the country and influenced its foreign policy.", "Scholars warned that the government's rhetoric risked encouraging a dangerous revanche among nationalist groups.", "The opposition camped on a platform of revanche, promising to overturn what they called humiliating concessions."], synonyms: ["revenge", "retaliation", "revanchism"], day: 42, group: 3 },
  { word: "retrospection", pos: "noun", arabic: "تأمل بالماضي / استرجاع الذكريات", definition: "The act of looking back and reflecting thoughtfully on past events or experiences.", examples: ["In retrospection, she recognized how much those early failures had taught her about resilience.", "The memoir is a work of careful retrospection, weighing youthful ambitions against later realities.", "Retrospection after the project revealed several process improvements that could prevent similar mistakes."], synonyms: ["reflection", "hindsight", "remembrance"], day: 42, group: 3 },
  { word: "retrenchment", pos: "noun", arabic: "تخفيض النفقات / تقليص التكاليف", definition: "The reduction of expenditures or the cutting back of operations, staff, or services in response to financial pressures.", examples: ["Faced with declining revenues, the company announced a retrenchment plan that included layoffs and facility closures.", "Government retrenchment during the recession led to reduced public services and increased unemployment in affected regions.", "The nonprofit's retrenchment forced it to prioritize core programs and suspend several community initiatives."], synonyms: ["austerity", "cutback", "downsizing"], day: 42, group: 3 },
  { word: "yoke", pos: "verb", arabic: "يَجْبِر / يُقيّد", definition: "To join, couple, or burden, especially with oppressive control or servitude; to subject to domination or hardship.", examples: ["The treaty effectively yoked the smaller states to the dominant power's military strategy.", "The farmers yoked the oxen together and began plowing the field at dawn.", "Debt can yoke even prosperous households, limiting their future choices and mobility."], synonyms: ["bind", "harness", "encumber"], day: 42, group: 3 },
  { word: "xenophobia", pos: "noun", arabic: "خوف من الأجانب / رهاب الأجانب", definition: "An irrational fear, hatred, or distrust of people from other countries or cultures, often manifested as discrimination or hostility.", examples: ["The politician's anti-immigrant rhetoric stirred xenophobia and led to several hate incidents.", "Efforts to combat xenophobia at the community level included multicultural festivals and educational programs.", "Surveys showed that economic anxiety, more than cultural differences, was fueling xenophobia in the region."], synonyms: ["bigotry", "nativism", "racism"], day: 42, group: 3 },
  { word: "resurgence", pos: "noun", arabic: "عودة قوية / انتعاش مجدد", definition: "A revival or renewed growth or activity after a period of decline or inactivity.", examples: ["There has been a resurgence of interest in traditional crafts among younger consumers.", "Public health officials warned of a resurgence in measles cases after vaccination rates dropped.", "The city's downtown experienced a resurgence when new businesses and cultural venues opened."], synonyms: ["revival", "renewal", "reawakening"], day: 42, group: 3 },
  { word: "winsome", pos: "adjective", arabic: "جذاب / لطيف", definition: "Attractive or charming in a fresh, innocent, or engaging way.", examples: ["Her winsome smile and easy manner made her an instant favorite at social gatherings.", "The novel's winsome protagonist wins over readers with her optimism and resourcefulness.", "Marketing used a winsome mascot to soften the brand's image and appeal to families."], synonyms: ["charming", "engaging", "endearing"], day: 42, group: 3 },
  { word: "winnow", pos: "verb", arabic: "يغربل / ينقّي", definition: "To separate or remove unwanted elements from a larger group, to sift or sort decisively.", examples: ["Editors must winnow hundreds of submissions to select a dozen pieces for the anthology.", "Farmers historically winnowed the grain by allowing the wind to blow away the chaff.", "The hiring committee winnowed the candidate list to three finalists after the first round of interviews."], synonyms: ["sift", "separate", "filter"], day: 42, group: 3 },
  { word: "whitewash", pos: "verb", arabic: "يغطّي الأخطاء / يموّه", definition: "To conceal, gloss over, or minimize wrongdoing, failures, or unpleasant facts, often by providing a misleadingly favorable account.", examples: ["The investigation concluded that officials had tried to whitewash the scandal rather than hold anyone accountable.", "Histories that whitewash colonial abuses risk perpetuating injustice by erasing victims' experiences.", "Critics accused the company of attempting to whitewash safety lapses in its public statements."], synonyms: ["cover up", "gloss over", "sanitize"], day: 42, group: 3 },
];
