...
export default function Test({ onNavigate }: TestProps) {
  const sections: SectionCard[] = [
    ...
    },
    {
      id: "timed-test",
      title: "Timed Test",
      subtitle: "Exam-style with one clock",
      description:
        "Pick your sources, question types, and length. Answers are locked until the end — flag questions, navigate freely, then review and submit.",
      ...
      items: [
        "Choose source belts & types",
        "10 / 20 / 30 / 50 or custom count",
        "One overall timer · per-question time tracked",
        "Flag-for-review · review screen · final submit",
      ],
      cta: "Configure & start",
      status: "available",
