  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50/40 via-background to-orange-50/40 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 space-y-5">
              ...
              <div className="flex flex-col gap-2.5 w-full">
                {libraryMode ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={() => onContinue(firstWordId)}
                      className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-colors"
                      data-testid="button-skip-to-flashcards"
                    >
                      Skip to Flashcards <ChevronRight size={12} />
                    </button>
                  </>
                )}
              </div>
        ...
        {/* ── Result Card (after comprehension submit) ── */}
        {submitted && (
          <motion.div
            ref={resultCardRef}
            initial={{ opacity: 0, y: 8 }}
            ...
            className="relative overflow-hidden rounded-3xl border border-orange-200/70 dark:border-orange-500/20 bg-orange-50/70 dark:bg-orange-500/5 shadow-sm scroll-mt-6"
            data-testid="card-comprehension-result"
          >
            <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-5 md:gap-6 p-6 sm:p-7 items-center">
              {/* Score badge */}
              <div className="flex items-center gap-4 md:flex-col md:items-center md:text-center">
                ...
                >
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-wider text-white/85 mt-1 tabular-nums">
              ...
              <div className="space-y-1.5 min-w-0">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                  {scorePct === 100
                    ? "You absorbed every detail. The flashcards will lock these words into long-term memory."
                    : scorePct >= 80
                    ? "You've got the gist. The flashcards will sharpen the finer details."
                    : scorePct >= 50
                    ? "Good first pass. The flashcards will fill in what's still fuzzy."
                    : "No worries — that's exactly what the flashcards are for. Let's lock these in."}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2 w-full md:w-56">
                {!libraryMode && (
                  <button
                    onClick={() => onContinue(firstWordId)}
                    className="btn-brand w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-sm shadow-md"
                    data-testid="button-result-start-flashcards"
                  >
                ...
                <button
                  onClick={reset}
                  className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-colors"
                  data-testid="button-result-try-again"
                >
                  <RotateCcw size={12} /> Try Comprehension Again
                </button>
                {libraryMode && (
                  <button
                    onClick={() => onNavigate?.("story-library")}
